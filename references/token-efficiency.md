...
- <chỉ correction mới từ plan review>

VERIFICATION:
- <focused tests phù hợp với Round>

Phản hồi hoàn toàn bằng tiếng Việt; giữ nguyên thuật ngữ kỹ thuật tiếng Anh khi chính xác hơn.
Không lặp lại plan.
Không commit/tag/push.
Không bắt đầu Round/Phase tiếp theo.
```
...
Đọc AGENTS.md và chỉ các project docs liên quan.

MỤC TIÊU:
<một mục tiêu ngắn gọn>

EVIDENCE / CURRENT GAP:
<chỉ evidence hiện tại>

ACCEPTANCE:
1. ...
2. ...

PLAN ONLY. Inspect phạm vi nhỏ nhất liên quan trước.
...
REVIEW DELTA / GUARDRAIL:
- <chỉ constraint mới từ plan review, nếu có>

Chạy focused + directly relevant regression tests; chỉ mở rộng khi risk yêu cầu.
Báo cáo ngắn gọn, không lặp lại plan.
...
1. files changed;
2. behavior changed;
3. exact tests/builds và PASS/FAIL;
4. deviations/blockers/known risks;
5. manual QA steps.
Không lặp lại plan hoặc paste diff/log dài.
Phản hồi hoàn toàn bằng tiếng Việt; giữ nguyên thuật ngữ kỹ thuật tiếng Anh khi cần để chính xác.
```
